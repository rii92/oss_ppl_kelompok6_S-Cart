              ...
              <div class="rd-navbar-main">
                ...
                <div class="rd-navbar-nav-wrap">
                  ...
                  <ul class="rd-navbar-nav">
                    ...
                    <li class="rd-nav-item">
                        <a class="rd-nav-link" href="#">
                        <i class="fa fa-usd" aria-hidden="true"></i> <i class="fas fa-caret-down"></i>
                        </a>
                        <ul class="rd-menu rd-navbar-dropdown">
                    ...
                    <li class="rd-nav-item">
                        <a class="rd-nav-link" href="#">
                        <i class="fa fa-sign-in" aria-hidden="true"></i> <i class="fas fa-caret-down"></i>
                        </a>
                        <ul class="rd-menu rd-navbar-dropdown">
      
                            <li class="rd-dropdown-item">
                                <a class="rd-dropdown-link" href="{{ sc_route('login') }}"> LOGIN </a>
                            </li>
                            <li>
                                <a class="rd-dropdown-link" href="{{ sc_route('register') }}"> REGISTER </a>
                            </li>
                    ...
                    <!-- <li class="rd-nav-item">
                        <ul class="rd-menu rd-navbar-dropdown">
                          <li class="rd-nav-item">
                            <a class="rd-nav-link" href="{{ sc_route('login') }}"> LOGIN </a>
                          </li>
                          <li class="rd-nav-item">
                            <a class="rd-nav-link" href="{{ sc_route('register') }}"> REGISTER </a>
                           </li>
                        </ul>
                    </li> -->
