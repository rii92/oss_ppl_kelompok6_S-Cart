...
.invalid .help-block {
 ...
 .main-sidebar .sidebar-lightblue  li.header{
  ...
  color: #ffffff !important;
    background: #4da0f1 #c7626c !important;
    */
    ...
    border-bottom: solid 3px #4da0f1;
  }
  ...
  /* .sidebar .nav-item.has-treeview li {
    margin: 5px 0;
  } */
  ...
  .main-sidebar .sidebar-success  li.header{
    ...
    /* new */ 
    margin: 15px;
    color: #1b7a31 !important;
    background: #ffffff !important;
    border-bottom: solid 3px #1b7a31;
  }
  ...
  .main-sidebar .sidebar-white  li.header{
    ...
    background: #ffffff !important;
    border-bottom: solid 3px #96a3ab;
  }
  ...
  /* color: #ffffff !important;
    ...
    /* new */ 
    margin: 15px;
    color: #c75b8c !important;
    background: #ffffff !important;
    border-bottom: solid 3px #c75b8c;
  }
